...
(function () {
    ...
    plupload.Uploader = function (settings) {
        ...
        function calc() {
            ...
            if (total.size === undef) {
                ...
                if (total.loaded === uploadedFileSize) {
                    total.bytesPerSec = 0;
                } else {
                    total.bytesPerSec = Math.ceil((total.loaded - uploadedFileSize - (settings.uploaded_bytes || 0)) / ((+new Date() - startTime || 1) / 1000.0));
                }
     ...
     * @param {String} fullPath File fullPath.
     */
    plupload.File = function (id, name, size, fullPath,isDirectory) {
