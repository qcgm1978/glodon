...
App.Comm.AuthConfig = {
	...
	Project: {
		...
		//计划
		PlanTab: {
			tab: '<li data-type="plan" class="item plan" ><span-i data-i18n="data.drawing-model.Design">计划</span-i><i class="line"></i></li>',
			modularization: '<li data-type="model" class="item selected">' +
            (App.Local.getTranslation('drawing-model.Module')||'模块化') +
            '</li>',
			simulation: '<li data-type="analog" class="item">' +
            (App.Local.getTranslation('drawing-model.Simulate')||'模拟') +
            '</li>',
